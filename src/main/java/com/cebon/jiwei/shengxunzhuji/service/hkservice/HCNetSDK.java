...
public interface HCNetSDK extends StdCallLibrary {
    ...
    /*   HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("E:\\IdeaWorkSpace\\盛邦\\省纪委\\shengxunzhuji\\lib\\hik\\HCNetSDK", HCNetSDK.class);
     */
...
//NET_DVR_Login()参数结构
    ...
    //boolean  NET_DVR_PlayBackControl_V40(NativeLong lPlayHandle, int dwControlCode, int dwInValue, IntByReference LPOutValue);
...
interface PlayCtrl extends StdCallLibrary {
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(".\\lib\\hik\\PlayCtrl",
            PlayCtrl.class);
